/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 1742b5463151fe2e51ab1dd4414b36d8)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	PAPERKG_STORAGE: R2Bucket;
	PAPERKG_DB: D1Database;
	OAUTH_REGISTRATION_RATE_LIMITER: RateLimit;
	OAUTH_FLOW_RATE_LIMITER: RateLimit;
	PUBLIC_BASE_URL: "https://paperkg-remote.nhtgb021030.workers.dev";
	OWNER_GITHUB_LOGIN: "inharlans";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BASE_URL" | "OWNER_GITHUB_LOGIN">> {}
}
